 ...
 */
package dev.ronaldomarques.dryve.desafio1.api.exception;
 ...
 * @since    20210315.
 * @version  20210315.
 * @category Serviço para Exceções: Classe final static para servir classes herdeiras de 'Exception'
 * @Análise  ...
 */
public final class DescritorExcecaoService {
	
	public static String descrever(Exception excep) {
	...
	public static String descreverInesperada(Exception excep) {
