...
public final class DryveChallenge1Controller {
	...
	public String help() {
		...
		return "<HTML>"
				...
				+ "<BR/>"
				+ "<ul>"
				+ "	<li>Help (basic version), GET, http/1.1, '/help'</li><BR/>"
				+ "	<BR/>"
				...
				+ "	<BR/>"
				+ "	<li>Brands addition, POST, http/1.1, '/brands', body payload in JSON:<BR/>"
				+ "	{<BR/>"
				+ " &nbsp; &nbsp; \"name\": \"&lt;value&gt;\"<BR/>"
				+ "	}<BR/>"
				+ "	<li>Models addition, POST, http/1.1, '/models', body payload in JSON:<BR/>"
				+ "	{<BR/>"
				+ "	&nbsp; &nbsp; \"name\": \"&lt;value&gt;\",<BR/>"
				+ "	&nbsp; &nbsp; \"brand\": {<BR/>"
				+ "	&nbsp; &nbsp; &nbsp; &nbsp; \"id\": \"&lt;UUID-value&gt;\"<BR/>"
				...
				+ "	}<BR/>"
				+ "	<BR/>"
				+ "	<li>Models-Years-Relation addition, POST, http/1.1, '/models', body payload in JSON:<BR/>"
				+ "	{<BR/>"
				+ "	&nbsp; &nbsp; \"model\": {<BR/>"
				+ "	&nbsp; &nbsp; &nbsp; &nbsp; \"id\": \"&lt;UUID-value&gt;\"<BR/>"
				+ "	&nbsp; &nbsp; }<BR/>"
